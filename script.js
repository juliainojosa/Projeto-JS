...
function mostrarLivro() {
    ...
    if (generoSelecionado === "fantasia") {
    ...
    else if (generoSelecionado === "ficcao") {

        nome = "Duna";

        descricao =
            "Uma ficção científica épica sobre poder, política e sobrevivência.";
        ...
        descricao =
            "Um grupo de amigos enfrenta uma entidade assustadora em sua cidade.";

        imagem =
            "https://m.media-amazon.com/images/I/91g9Dvtf+jL.jpg";
    }
        ...
        descricao =
            "Percy descobre que é filho de um deus grego e embarca em uma aventura.";

        imagem =
            "https://m.media-amazon.com/images/I/51LFxWvS11L._SY445_SX342_ML2_.jpg";
    }
